...
VALUES (1, 'Омлет', 250, '1.png', 4.5, 200, 'Сочный омлет с травами и сыром.'),
       (2, 'Паста карбонара', 350, '1.png', 4.8, 300, 'Итальянская паста с беконом и сливочным соусом.'),
       (3, 'Стейк из говядины', 600, '1.png', 4.9, 400, 'Нежный стейк, подается с овощами и картошкой.'),
       (4, 'Мохито', 150, '1.png', 4.7, 300, 'Освежающий коктейль с мятой и лаймом.'),
       (5, 'Тирамису', 200, '1.png', 4.6, 150, 'Классический итальянский десерт на основе маскарпоне и кофе.');
